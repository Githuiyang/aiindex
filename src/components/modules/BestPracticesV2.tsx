              ...
              <div className="space-y-6 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                      <Textarea 
                        ...
                        className="bg-zinc-900 border-zinc-800 text-white min-h-[300px] font-mono text-sm whitespace-pre-wrap"
                      />
                      <Button
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-zinc-800">
                  ...
                  <Button 
                    ...
                    disabled={isAnalyzing || isSubmitting || !manualTitle.trim() || !manualContent.trim()}
                    className="bg-white text-black hover:bg-zinc-200"
                  >
                    {isSubmitting ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <ArrowRight className="mr-2" size={16} />}
                    保存
                  </Button>
                </div>
              </div>
          ...
          {practices.map((item) => (
            ...
            >
              {item.url && (item.url.includes('twitter.com') || item.url.includes('x.com')) ? (
                 <div className="w-10 h-10 bg-black rounded-full mb-4 flex items-center justify-center border border-zinc-800">
                    <svg viewBox="0 0 24 24" className="w-5 h-5 text-white fill-current"><g><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></g></svg>
                 </div>
              ) : item.logo_url ? (
